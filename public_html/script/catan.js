...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constEs6 = __webpack_require__(53);

	var _buildEs6 = __webpack_require__(54);

	var _robberEs6 = __webpack_require__(56);

	var _tradeEs6 = __webpack_require__(57);

	var _devcardEs6 = __webpack_require__(58);

	var _catanEs6 = __webpack_require__(59);
	...
	var run = regeneratorRuntime.mark(function callee$0$0() {
	    ...
	    return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
	        while (1) switch (context$1$0.prev = context$1$0.next) {
	            case 0:
	                catan = new _catanEs6.Catan(run, socket);
	                game = undefined, player = undefined, data = undefined;
	            ...
	            case 2:
	                ...
	                context$1$0.next = 5;
	                return catan.chooseGameFormShow();
	            ...
	            case 5:
	                ...
	                player = _ref2[1];
	                context$1$0.next = 11;
	                return socket.emit('game:join', [game, player], function () {
	                    for (var _len = arguments.length, params = Array(_len), _key = 0; _key < _len; _key++) {
	                        params[_key] = arguments[_key];
	                    }

	                    return run.next(params);
	                });
	            ...
	            case 21:
	                if (!(data.players[player].color === '')) {
	                    context$1$0.next = 27;
	                    break;
	                }

	                context$1$0.next = 24;
	                return catan.chooseColorShow(data);
	            ...
	            case 30:
	                build = new _buildEs6.Build(run, socket, player);
	                robber = new _robberEs6.Robber(run, socket, player);
	                trade = new _tradeEs6.Trade(run, socket, player);
	                devcard = new _devcardEs6.DevCard(run, socket, player);

	            case 34:
	                if (!(data.gameState == _constEs6.CONST.OPEN)) {
	                    context$1$0.next = 41;
	                    break;
	                }
	            ...
	            case 41:
	                if (!(data.gameState == _constEs6.CONST.SETUP)) {
	                    context$1$0.next = 67;
	                    break;
	                }
	                ...
	                house = undefined;
	                context$1$0.next = 46;
	                return build.houseShow(data);

	            case 46:
	                _ref4 = context$1$0.sent;
	                _ref42 = _slicedToArray(_ref4, 2);
	                _ref42$1 = _slicedToArray(_ref42[1], 2);
	                data = _ref42$1[0];
	                house = _ref42$1[1];

	                (0, _arrangeEs6.arrange)(data, player);
	                context$1$0.next = 54;
	                return build.roadShow(data, house);
	            ...
	            case 67:
	                ...
	                if (!data.players[player].hand[_constEs6.CONST.DEVELOPMENT][_constEs6.CONST.KNIGHT]) {
	                    context$1$0.next = 82;
	                    break;
	                }

	                context$1$0.next = 73;
	                return catan.playKnightShow();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adjacentEs6 = __webpack_require__(55);
	...
	var Build = (function () {
	    ...
	    _createClass(Build, [{
	            ...
	            var _loop = function (i) {
	                var _loop2 = function (j) {
	                    ...
	                    if (data.houses[i][j][0] === 0) {
	                        //If the house is not already built
	                        //Count available resources
	                        var hand = data.players[_this2[PLAYER]].hand[_constEs6.CONST.RESOURCE];
	                        var hasResources = hand[_constEs6.CONST.WOOL] && hand[_constEs6.CONST.WOOD] && hand[_constEs6.CONST.BRICK] && hand[_constEs6.CONST.WHEAT];
	                        var adj_road = (0, _adjacentEs6.adjacent)(i, j, 'house', 'road');
	                        var adj_house = (0, _adjacentEs6.adjacent)(i, j, 'house', 'house');
	                        //Check for the adjacent roads
	                        var n = undefined;
	                        for (n = 0; n < adj_road.length; n++) {
	                            if (data.roads[adj_road[n][0]][adj_road[n][1]] == data.players[_this2[PLAYER]]) {
	                                break;
	                            }
	                        }
	                        //Allow if the player has resources and there is a road nearby
	                        //Or if in setup mode a house can be built anywhere
	                        if (data.gameState == _constEs6.CONST.SETUP || n != adj_road.length && hasResources) {
	                ...
	                for (var j = 0; j < data.houses[i].length; j++) {
	                    _loop2(j);
	                }
	            };
	        ...
	        key: 'roadShow',
	        value: function roadShow(data, options) {
	            var _this4 = this;
	            ...
	            var hand = data.players[this[PLAYER]].hand[_constEs6.CONST.RESOURCE];
	            if (free || hand[_constEs6.CONST.WOOD] && hand[_constEs6.CONST.BRICK]) {
	                //If the player has enough resources
	                if (intersection) {
	                    //If an intersection is being forced, only allow houses around there
	                    var roads = (0, _adjacentEs6.adjacent)(intersection[0], intersection[1], "house", "road");
	                    ...
	                    var _loop4 = function (i) {
	                        var _loop5 = function (j) {
	                            ...
	                            if (data.roads[i][j] == -1) {
	                                var road = document.getElementsByClassName("road_row")[i].getElementsByClassName("road")[j];
	                                var roads = (0, _adjacentEs6.adjacent)(i, j, "road", "road");
	                                var n = undefined;
	                                ...
	                                if (n != roads.length) {
	                                    ...
	                                    road.style.cursor = "pointer";
	                                    road.onclick = function () {
	                                        _this4.road(i, j, data);
	                                    };
	                                }
	                            }
	                        };

	                        for (var j = 0; j < data.roads[i].length; j++) {
	                            _loop5(j);
	                        }
	                    };
	        ...
	        key: 'roadHide',
	        value: function roadHide(data) {
	            for (var i = 0; i < data.roads.length; i++) {
	                for (var j = 0; j < data.roads.length; j++) {
	    ...
	    var adj = {
	        tile: {
	            road: function road(a, b) {
	                var x = [[[a * 2, b * 2], [a * 2, b * 2 + 1], [a * 2 + 1, b * 2], [a * 2 + 1, b * 2 + 1], [a * 2 + 2, b * 2 + 1], [a * 2 + 2, b * 2 + 2]], [[a * 2, b * 2 + 1], [a * 2, b * 2 + 2], [a * 2 + 1, b * 2], [a * 2 + 1, b * 2 + 1], [a * 2 + 2, b * 2 + 1], [a * 2 + 2, b * 2 + 2]], [[a * 2, b * 2 + 1], [a * 2, b * 2 + 2], [a * 2 + 1, b * 2], [a * 2 + 1, b * 2 + 1], [a * 2 + 2, b * 2], [a * 2 + 2, b * 2 + 1]]];
	                return x[Math.floor(a / 2)];
	            },
	            house: function house(a, b) {
	                var x = [[[a, b * 2], [a, b * 2 + 1], [a, b * 2 + 2], [a + 1, b * 2 + 1], [a + 1, b * 2 + 2], [a + 1, b * 2 + 3]], [[a, b * 2], [a, b * 2 + 1], [a, b * 2 + 2], [a + 1, b * 2], [a + 1, b * 2 + 1], [a + 1, b * 2 + 2]], [[a, b * 2 + 1], [a, b * 2 + 2], [a, b * 2 + 3], [a + 1, b * 2], [a + 1, b * 2 + 1], [a + 1, b * 2 + 2]]];
	        ...
	        road: {
	            road: function road(a, b) {
	                var x = undefined,
	                    ...
	                    set = undefined;
	                if (a % 2) {
	                    x = [[[a - 1, b * 2 - 1], [a - 1, b * 2], [a + 1, b * 2], [a + 1, b * 2 + 1]], [[a - 1, b * 2 - 1], [a - 1, b * 2], [a + 1, b * 2 - 1], [a + 1, b * 2]], [[a - 1, b * 2], [a - 1, b * 2 + 1], [a + 1, b * 2 - 1], [a + 1, b * 2]]];
	                    set = x[1 - (a < 5) + (a > 5)];
	                    ...
	                    x = [[[a, b - 1], [a, b + 1], [a - 1, Math.floor(b / 2)], [a + 1, Math.ceil(b / 2)]], [[a, b - 1], [a, b + 1], [a + 1, Math.ceil(b / 2)], [a + 1, Math.floor(b / 2)]]];
	            ...
	            house: function house(a, b) {
	                if (a % 2) {
	                    var x = [[[a - 1, b * 2], [a + 1, b * 2 + 1]], [[a - 1, b * 2], [a + 1, b * 2]], [[a - 1, b * 2 + 1], [a + 1, b * 2]]];
	                    return x[1 - (a < 5) + (a > 5)];
	                } else {
	                    return [[a, b], [a, b + 1]];
	                }
	        ...
	        house: {
	            road: function road(a, b) {
	                var x = [[[a * 2, b - 1], [a * 2, b], [a * 2 + (~b & 1) - (b & 1), Math.floor(b / 2)]], [[a * 2, b - 1], [a * 2, b], [a * 2 - (~b & 1) + (b & 1), Math.floor(b / 2)]]];
	                var set = x[0 + (a > 2)];
	            ...
	            house: function house(a, b) {
	                var x = [[[a, b - 1], [a, b + 1], [a + (~b & 1) - (b & 1), b + (~b & 1) - (b & 1)]], [[a, b - 1], [a, b + 1], [a + (~b & 1) - (b & 1), b - (b & 1)]], [[a, b - 1], [a, b + 1], [a - (~b & 1) + (b & 1), b - (b & 1)]], [[a, b - 1], [a, b + 1], [a - (~b & 1) + (b & 1), b + (~b & 1) - (b & 1)]]];
	                var set = x[Math.max(0, Math.min(i - 1, 3))];
	                for (var y = set.length - 1; y >= 0; y--) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Robber = (function () {
	    ...
	    _createClass(Robber, [{
	        ...
	        key: 'discard',
	        value: function discard(discarded) {
	            this[SOCKET].emit('robber:discard', [discarded, this[PLAYER]], this[GEN].next);
	        }
	    }, {
	        key: 'discardShow',
	        value: function discardShow(discarded, data) {}
	    }, {
	        key: 'discardHide',
	        value: function discardHide(data) {}
	    }, {
	        key: 'wait',
	        value: function wait() {
	        ...
	        key: 'moveShow',
	        value: function moveShow(data) {
	            var _this = this;

	            var _loop = function (i) {
	                var _loop2 = function (j) {
	                    if (data.robber[0] != i || data.robber[1] != j) {
	                        var rob = document.getElementsByClassName('tile_row')[i].getElementsByClassName('tile')[j].getElementsByClassName('robber')[0];
	        ...
	        key: 'steal',
	        value: function steal(target, data) {
	            this[SOCKET].emit('robber-steal', target, this[GEN].next);
	            this.stealHide(data);
	        }
	    }, {
	        key: 'stealShow',
	        value: function stealShow(data) {
	            var _this2 = this;

	            var adj = (0, _adjacentEs6.adjacent)(data.robber[0], data.robber[1], 'tile', 'house');
	            adj.forEach(function (target) {
	                if (data.houses[target[0]][target[1]][0] !== 0 && data.houses[target[0]][target[1]][1] != data.players[_this2[PLAYER]].turn) {
	                    (function () {
	                        var p = undefined;
	                        ...
	                        if (data.playerss[p].hand[_constEs6.CONST.RESOURCE].reduce(function (p, c) {
	                            return p + c;
	                        }, 0)) {
	                            var house = document.getElementsByClassName('house_row')[target[0]].getElementsByClassName('house')[target[1]];
	                            house.style.cursor = 'pointer';
...
/***/ function(module, exports) {
	...
	var Trade = function Trade(g, s, p) {
...
/***/ function(module, exports) {
	...
	var DevCard = function DevCard(g, s, p) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Catan = (function () {
	    ...
	    _createClass(Catan, [{
	        key: 'awaitData',
	        value: function awaitData() {
	            var _this = this;

	            this[SOCKET].once('game:data', function (data) {
	                (0, _arrangeEs6.arrange)(data, _this[PLAYER]);
	                _this[GEN].next(data);
	            });
	        }
	    }, {
	        ...
	        value: function chooseColor(color) {
	            ...
	            this[SOCKET].emit("game:color", color, function (err, res) {
	                _this2[GEN].next(res);
	            });
	        ...
	        key: 'chooseColorShow',
	        value: function chooseColorShow(data) {
	            var _this3 = this;
	            ...
	            if (colors.length) {
	                (function () {
	                    ...
	                    var overlay = (0, _jquery2['default'])('#request_form');
	                    overlay.css('display', 'block');
	                    var options = (0, _jquery2['default'])('<div></div>');
	                    options.css({
	                        'margin': '0 auto',
	                        'text-align': 'center'
	                    });
	                    ...
	                    colors.forEach(function (color) {
	                        var div = (0, _jquery2['default'])('<div></div>').attr('class', 'color_selector').css('background-color', color).click(function () {
	                            _this3.chooseColor(color);
	                        });
	                        options.append(div);
	                    });
	                })();
	        ...
	        key: 'chooseColorHide',
	        value: function chooseColorHide() {
	            (0, _jquery2['default'])('#request_form').css('display', 'none').html("");
	        }
	    }, {
	        key: 'chooseGameFormShow',
	        value: function chooseGameFormShow() {
	            var _this4 = this;

	            (0, _jquery2['default'])('#start_form').css('display', 'block').submit(function (e) {
	                if ((0, _jquery2['default'])('#game_name').val() !== '' && (0, _jquery2['default'])('#your_name').val() !== '') {
	                    _this4.chooseGameFormHide();
	                    _this4[PLAYER] = (0, _jquery2['default'])('#your_name').val();
	                    _this4[GEN].next([(0, _jquery2['default'])('#game_name').val(), _this4[PLAYER]]);
	                }
	                e.preventDefault();
	            });
	        }
	    }, {
	        key: 'chooseGameFormHide',
	        value: function chooseGameFormHide() {
	            (0, _jquery2['default'])('#start_form').css('display', 'none').off('submit');
	        }
	    }, {
	        key: 'error',
	        ...
	        key: 'startButtonShow',
	        value: function startButtonShow() {
	            var _this5 = this;

	            (0, _jquery2['default'])('#start_game').css('display', 'block').off('click') //Don't add multiple handlers
	            .click(function () {
	                _this5[SOCKET].emit('game:start');
	                _this5.startButtonHide();
	            });
	        }
	    }, {
	        key: 'startButtonHide',
	        value: function startButtonHide() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrange = function arrange(data, your_name) {
	    var i = undefined,
	        j = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var date       = new Date(-5e13 - 1)
	  , brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z'
	      && __webpack_require__(82)(function(){ new Date(NaN).toISOString(); }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(68)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(67)
	  , setTag   = __webpack_require__(70).set
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(74);
	$def($def.S, 'Object', {setPrototypeOf: __webpack_require__(92).set});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P + $def.F * !__webpack_require__(82)(function(){ 'q'.endsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// should throw error on regex
	$def($def.P + $def.F * !__webpack_require__(82)(function(){ 'q'.startsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(67)
	  , setUnscope = __webpack_require__(117)
	  , ITER       = __webpack_require__(73).safe('iter')
	  , $iter      = __webpack_require__(104)
	  , step       = $iter.step
	  , Iterators  = $iter.Iterators;
	...
	__webpack_require__(105)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!(UNSCOPABLES in []))__webpack_require__(67).hide(Array.prototype, UNSCOPABLES, {});
	module.exports = function(key){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(67)
	  ...
	  , asap     = process && process.nextTick || __webpack_require__(127).set
	  , P        = global[PROMISE]
	  , isFunction     = $.isFunction
	  , isObject       = $.isObject
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(78)
	  , get  = __webpack_require__(104).get
	  , call = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(67)
	  ...
	  , assert   = __webpack_require__(79)
	  , forOf    = __webpack_require__(126)
	  , step     = __webpack_require__(104).step
	  , $has     = $.has
	  , set      = $.set
	  , isObject = $.isObject
	  , hide     = $.hide
	...
	module.exports = {
	  ...
	  setIter: function(C, NAME, IS_MAP){
	    __webpack_require__(105)(C, NAME, function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $     = __webpack_require__(67)
	  , $def  = __webpack_require__(74)
	  , BUGGY = __webpack_require__(104).BUGGY
	  , forOf = __webpack_require__(126)
	  , species = __webpack_require__(119)
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  ...
	  function fixMethod(KEY){
	    var fn = proto[KEY];
	    __webpack_require__(75)(proto, KEY,
	  ...
	  __webpack_require__(70).set(C, NAME);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(74);
	$def($def.S, 'RegExp', {
	  escape: __webpack_require__(81)(/[\\^$*+?.()|[\]{}]/g, '\\$&', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(116);
	var $           = __webpack_require__(67)
	  , Iterators   = __webpack_require__(104).Iterators
	  , ITERATOR    = __webpack_require__(71)('iterator')
